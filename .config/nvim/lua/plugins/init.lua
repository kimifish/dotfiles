    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>ls', require('telescope.builtin').lsp_document_symbols, '[D]ocument Symbols')
          ...
          map('<leader>lfa', vim.lsp.buf.add_workspace_folder, 'Workspace [A]dd Folder')
          map('<leader>lfr', vim.lsp.buf.remove_workspace_folder, 'Workspace [R]emove Folder')
          map('<leader>lfl', function()
